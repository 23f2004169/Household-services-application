<template>
    <nav class="navbar bg-body-tertiary fixed-top" style="background-color: #3b0a03;">
        <div class="container-fluid" style="background-color: #3b0a03;">
            ...
            <a href="/prof_search"><button style="background-color: #3b0a03;">Search</button></a>
            <a href="/prof_summary"><button style="background-color: #3b0a03;">Summary</button></a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarlabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/prof_dashboard">Home</a>
                        </li>
